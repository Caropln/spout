...
#   Character.create(name: 'Luke', movie: movies.first)
 ...
 Activities.create!(name: 'Park')
  ...
  Places.create! (name: 'Stade Henri TASSO' address: '1 place du 4 septembre 13007 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Terrain de basket TELLENE' address: 'STADE DI GIOVANI TELLENE 89 BOULEVARD TELLENE 13007 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Terrain de basket' address: 'Rue du Bois Sacré 13006 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Terrain de basket' address: 'Allée de la bastide basse 13012 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Terrain de basket chabanon' address: '23 Rue Albert Chabanon 13006 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')

  Places.create! (name: 'La Major' address: 'Place de la Major 13002 MARSEILLE' accessibility: 'Terrain de pétanque au niveau de la Cathédrale La Major.' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Boule Florian' address: '38 avenue Florian 13010 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Boule Arc de Triomphe' address: '32 rue hoche Quartier St Lazare 13003 MARSEILLE' accessibility: 'A 200m de la station de métro Clary.' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Plage des Catalans' address: 'Quartier des Catalans Corniche Kennedy 13007 MARSEILLE' accessibility: 'Terrain accessible au niveau de la plage.' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Parc Émile Duclaux' address: '86 Boulevard Charles Livon 13007 MARSEILLE' accessibility: 'Accessible au niveau de l’entrée du park' schedules: '08:00 - 21:00' pictures: '' lat: '' long: '')

  Places.create! (name: 'Mni Foot Peras' address: 'Rue du Péras 13013 MARSEILLE' accessibility: 'En accès libre' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'City satde du Jaï' address: 'Avenue Henri Fabre 13700 MARSEILLE' accessibility: 'Parking et commodité' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Mini Foot Jean Bouin' address: '65 Avenue Clot Bey 13008 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Beach Soccer' address: '5 Boulevard Gustave Ganay  13009 MARSEILLE' accessibility: '-' schedules: '-' pictures: '' lat: '' long: '')
  Places.create! (name: 'Mini foot Burel' address: '23 Boulevard BUREL 13014 MARSEILLE' accessibility: 'En accès libre' schedules: '-' pictures: '' lat: '' long: '')
